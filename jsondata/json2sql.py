...
def movie_genre():
    ...
    """
    # 读取文件
    movie_file_path = '../../data/mysql_table/movie_info.txt'
    movie_str_list = open(movie_file_path, 'r', encoding='utf-8').readlines()
...
def movie_person():
    ...
    """
    # 读取文件
    movie_person_file_path = '../../data/mysql_table/movie_person_info.txt'
    movie_person_str_list = open(movie_person_file_path, 'r', encoding='utf-8').readlines()
...
def book_genre():
    ...
    """
    # 读取文件
    book_file_path = '../../data/mysql_table/book_info.txt'
    book_str_list = open(book_file_path, 'r', encoding='utf-8').readlines()
...
def book_person():
    ...
    """
    # 读取文件
    book_person_file_path = '../../data/mysql_table/book_person_info.txt'
    book_person_str_list = open(book_person_file_path, 'r', encoding='utf-8').readlines()
