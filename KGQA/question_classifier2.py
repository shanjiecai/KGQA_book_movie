...
from KGQA.ltp import check_name
import jieba


class AnalysisQuestion():
    def __init__(self):
        jieba.load_userdict(r'D:\PycharmProjects\KGQA_HLM2\raw_data\book.txt')
        jieba.load_userdict(r'D:\PycharmProjects\KGQA_HLM2\raw_data\movie.txt')
